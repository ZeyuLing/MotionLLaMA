...
from mmotion.utils.task import tasks_for_t2m_data, PRETRAIN_RANDOM_TEXT_MOTION_GENERATION, \
    PRETRAIN_RANDOM_MOTION_GENERATION

from mmotion.utils.files_io.json import write_json


def get_anno(data_dir: str = 'data/motionhub/humansc3d'):
    train_data_info = {
        'meta_info': {'dataset': 'humansc3d',
                      'version': 'v1'},
