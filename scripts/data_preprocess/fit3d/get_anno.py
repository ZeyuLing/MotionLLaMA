...
from mmotion.utils.task import MOTION_PREDICTION, MOTION_IN_BETWEEN, RANDOM_MOTION_GENERATION, DURATION_TO_MOTION, \
    PRETRAIN_RANDOM_MOTION_GENERATION, TEXT_TO_MOTION, MOTION_TO_TEXT, RANDOM_TEXT_MOTION_GENERATION, \
    RANDOM_TEXT_GENERATION, PRETRAIN_RANDOM_TEXT_MOTION_GENERATION, DURATION_TO_TEXT_MOTION, DURATION_TEXT_TO_MOTION, \
    tasks_for_t2m_data
...
def get_anno(data_dir: str = 'data/motionhub/fit3d'):
    ...
    for smplx_path in tqdm(glob(join(data_dir, 'train/s*/standard_smplx', '*.npz'))):
        ...
        sample = {
            ...
            'task': tasks_for_t2m_data,
            'pretrain_task': [PRETRAIN_RANDOM_MOTION_GENERATION, PRETRAIN_RANDOM_TEXT_MOTION_GENERATION]
