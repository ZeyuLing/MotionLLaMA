...
import mmotion.core.conventions.keypoints_mapping as keypoints_mapping
from mmotion.renderer.matplotlib3d_renderer import Axes3dJointsRenderer
from mmotion.utils.smpl_utils.demo_utils import get_different_colors
from mmotion.utils.render.keypoint_utils import search_limbs
from mmotion.utils.files_io.path_utils import prepare_output_path
...
def visualize_kp3d(
    ...
    Args:
        ...
        show_axis: whether to show axis in the fig.
    Raises:
    ...
    if value_range is not None:
        ...
        feet_height = np.min(pose_np_normed[..., 1]) - value_range[0]
        input_pose_np = pose_np_normed
    else:
        feet_height = np.min(kp3d[..., 1])
        input_pose_np = kp3d
    if feet_as_floor:
        input_pose_np[..., 1] -= feet_height
