...
KEYPOINTS_FACTORY = {
    ...
    'smplx_no_contour': smplx.SMPLX_KEYPOINTS_NO_CONTOUR,
    'smplh': smplx.SMPLH_KEYPOINTS,
...
def keypoint_index_mapping(from_source: str = 'smpl', to_source: str = 'smplx'):
    from_kpt_names = KEYPOINTS_FACTORY[from_source]
    to_kpt_names = KEYPOINTS_FACTORY[to_source]

    index = [to_kpt_names.index(name) for name in from_kpt_names]
    return index
