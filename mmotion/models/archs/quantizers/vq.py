...
from mmotion.models.archs.quantizers.utils import kmeans, sample_vectors, ema_inplace, laplace_smoothing, default, \
    uniform_init, broadcast_tensors
...
class VectorQuantizer(nn.Module):
    ...
    def forward(self, x):
        ...
        quantize = self.project_out(quantize)
        quantize = rearrange(quantize, "b n d -> b d n")
        return quantize, embed_ind, loss, None

    @property
    def codebook_size(self):
        return self._codebook.codebook_size

    @property
    def codebook_dim(self):
        return self._codebook.embed.shape[-1]