...
from mmotion.core.conventions.keypoints_mapping.mano import (
    MANO_LEFT_REORDER_KEYPOINTS,
    MANO_RIGHT_REORDER_KEYPOINTS,
)
from mmotion.core.conventions.keypoints_mapping.smplx import SMPLX_KEYPOINTS
from mmotion.core.conventions.segmentation import body_segmentation
from mmotion.models.utils.SMPLX import get_partial_smpl
from mmotion.registry import MODELS


# yapf: enable

@MODELS.register_module(name=['SMPLX', 'smplx'])
class SMPLX(_SMPLX):
    ...
    def forward(self,
        ...
        output = dict(
            ...
            left_hand_pose=smplx_output.left_hand_pose,
            right_hand_pose=smplx_output.right_hand_pose,
            joints=joints,
