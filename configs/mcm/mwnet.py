...
default_hooks = dict(
    ...
    checkpoint=dict(
        ...
        rule='less',
        greater_keys=['r_precision_top_1', 'r_precision_top_2', 'r_precision_top_3', 'diversity']
    ),
...
custom_hooks = [dict(type='BasicVisualizationHook', interval=20, in_batch_interval=250)]
vis_backends = [
    dict(type='JointsVisBackend', name='motion'),
    dict(type='TextVisBackend', name='text'),
