...
model = dict(
    type='TM2T',
    motion_tokenizer=dict(type='configs/vqvae/v1/vanilla_joints_64_1024code_512dim_3depth.py',
                          init_cfg=dict(
                              type='Pretrained',
                              checkpoint='work_dirs/vanilla_joints_64_1024code_512dim_3depth/best_MPJPE_epoch_1300.pth'
                          )),
    pretrained_tokenizer='checkpoints/flan-t5-base',
    transformer_config='checkpoints/tm2t/config.json',
...
custom_hooks = [dict(type='BasicVisualizationHook', interval=30, in_batch_interval=250)]
